...
|------|-----|
| **样本ID** | SSBR-014 |
| **文献编号** | Oil sucked SSBR (Lanxess 4526) |
...
| 参数 | Oil sucked SSBR | F-SSBR | 差异影响 |
|------|-----------------|--------|---------|
| 苯乙烯 | 26% | 25% | 相近 |
| 乙烯基 | 45% | **57%** | F-SSBR 更高 |
...
### 3.2 相容性略低于 F-SSBR 的原因

文献发现 cis-1,4 单元与树脂的相互作用最弱：
- Oil sucked SSBR 的 cis-1,4 含量 (14.5%) > F-SSBR (9%)
- 导致 Oil sucked SSBR 与树脂的相容性略低

## 四、工业产品特点

### 4.1 Lanxess 4526 产品信息
