...
polymer_fingerprint: --258000.0-21.1-38.1-[Si](OC)(OC)OC---7wt%
---
...
| 参数 | 数值 | 说明 |
|------|------|------|
| 苯乙烯含量 | 21.1 wt% | 三种 SSBR 中最低 |
| 乙烯基含量 | 38.1 mol% | 中等水平 |
| 数均分子量 (Mn) | 25.8×10⁴ g/mol | 三种中最低 |
| 分子量分布 (PDI) | 1.52 | 较窄 |
| 无规度 | 100% | 完全无规分布 |
| 分子结构 | 星形，平均 4 支链 | 多官能锂引发剂合成 |

### 官能化试剂

- **名称**: [3-(2-氨基乙基)氨基丙基]三甲氧基硅烷 (AMMO)
